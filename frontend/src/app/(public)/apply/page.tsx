...
export default function InternshipApplyPage() {
  ...
  const handleGoogleFallbackSubmitInline = async (e: React.FormEvent) => {
    e.preventDefault();
              ...
              {authTab === "google" ? (
                <div className="space-y-5 text-left">
                  ...
                  {!showGoogleFallback ? (
                    ...
                    <form onSubmit={handleGoogleFallbackSubmitInline} className="space-y-4 pt-1 text-xs">
                      <div className="p-3 bg-brand-500/10 border border-brand-500/30 text-brand-300 text-xs rounded">
                        Enter your Google account email below to connect instantly:
                      </div>

                      <div className="space-y-1.5">
                        <label className="text-ink-300 font-semibold flex items-center gap-1.5 text-xs">
                          <Mail className="w-4 h-4 text-brand-400" /> Google Email Address *
                        </label>
                        <input
                          type="email"
                          required
                      ...
                      <div className="space-y-1.5">
                        <label className="text-ink-300 font-semibold flex items-center gap-1.5 text-xs">
                          <User className="w-4 h-4 text-brand-400" /> Full Name (Optional)
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="flex gap-3 pt-2">
                        <button
                          ...
                          className="w-1/3 py-3 bg-ink-900 hover:bg-ink-800 text-ink-300 border border-ink-700 font-bold transition text-xs"
                        >
                          Back
                        </button>
                        <button
                          ...
                          className="w-2/3 py-3 bg-brand-600 hover:bg-brand-500 text-white font-bold transition flex items-center justify-center gap-2 text-sm disabled:opacity-50"
                        >
                          {fallbackLoading ? <Loader2 className="w-4 h-4 animate-spin" /> : "Sign In with Google →"}
                        </button>
                      </div>
                    </form>
                  )}
