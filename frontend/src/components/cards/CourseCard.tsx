 ...
 {tech}
  ...
  <div className="pt-6 mt-8 border-t-2 border-ink-800 flex items-center justify-between">
    ...
    <Link
      ...
      className="px-5 py-3 text-sm font-bold bg-brand-600 hover:bg-brand-500 text-white flex items-center gap-2 shadow-[2px_2px_0px_#ffffff] hover:translate-y-0.5 transition-all"
    >
      View & Enroll
